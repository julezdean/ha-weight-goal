...
`,Ct={number:["start_weight","target_weight","rate_per_week","manual_weight"],date:["start_date","end_date","manual_date"],button:["start_today","confirm_start_today","record_weight"],sensor:["weight","target_weight_today","deviation","trend","weight_progress","time_progress","remaining","projected_date","status","last_measurement"]},Pt=new Map;for(const[t,e]of Object.entries(Ct))for(const i of e)Pt.set(i,t);const Dt=[...Pt.keys()].sort((t,e)=>e.length-t.length),zt=["status","weight","last_measurement"];function Nt(t){const e=t.indexOf(".");if(e<0)return;const i=t.slice(0,e),s=t.slice(e+1);for(const t of Dt)if(Pt.get(t)===i&&(s===t||s.endsWith(`_${t}`)))return t}function Rt(t,e,i){e&&!t[e]&&Pt.get(e)===i.slice(0,i.indexOf("."))&&(t[e]=i)}function Tt(t,e,i){const s=e?t.devices?.[e]:void 0;if(s){const t=s.name_by_user||s.name;if(t)return t}const r=i.status??i.weight,n=r?t.states?.[r]?.attributes?.friendly_name:void 0;if(!n)return a(t,"card.fallback_name");const o=n.lastIndexOf(" ");return o>0?n.slice(0,o):n}function jt(e,i){const s=i.entity;let r=i.device_id;!r&&s&&(r=e.entities?.[s]?.device_id??void 0);let n,o=r?function(e,i){const s={};for(const r of Object.values(e.entities??{})){if(r.device_id!==i||r.platform!==t)continue;const e=r.translation_key??void 0;e&&Pt.has(e)?Rt(s,e,r.entity_id):Rt(s,Nt(r.entity_id),r.entity_id)}return s}(e,r):{};!Object.keys(o).length&&s&&(o=function(t,e){const i={},s=Nt(e);if(!s)return i;const r=e.slice(e.indexOf(".")+1),n=r.slice(0,r.length-s.length);for(const e of Dt){const s=`${Pt.get(e)}.${n}${e}`;t.states?.[s]&&(i[e]=s)}return i}(e,s)),s&&Rt(o,Nt(s),s);for(const[t,e]of Object.entries(i.entities??{}))e&&(o[t]=e);for(const t of zt){const e=o[t];if(e){n=e;break}}return{entities:o,deviceId:r,name:i.name??Tt(e,r,o),target:n}}const Ot=new Map;function Wt(e,i){const s="history"===i.source?i.weightEntity:i.target;if(!s)return Promise.resolve([]);const r=`${i.source}|${s}|${i.days??"all"}`,n=Ot.get(r);if(n&&n.stamp===i.stamp)return n.promise;const o="history"===i.source?async function(t,e,i){const s=new Date,r=new Date(s.getTime()-864e5*i),n=await t.connection.sendMessagePromise({type:"history/history_during_period",start_time:r.toISOString(),end_time:s.toISOString(),entity_ids:[e],minimal_response:!0,no_attributes:!0,significant_changes_only:!1}),o=n?.[e]??[],a=[];for(const t of o){const e=Number(t.s),i="number"==typeof t.lu?1e3*t.lu:NaN;Number.isFinite(e)&&Number.isFinite(i)&&a.push({t:i,v:e})}return a.sort((t,e)=>t.t-e.t)}(e,s,i.days??365):async function(e,i,s){const r=await e.callService(t,"get_measurements",s?{days:s}:{},{entity_id:i},!1,!0),n=r?.response??{},o=[];for(const t of Object.values(n.entries??{}))for(const e of t.measurements??[]){const t=Date.parse(e.timestamp),i=Number(e.weight);Number.isFinite(t)&&Number.isFinite(i)&&o.push({t,v:i,source:e.source})}return o.sort((t,e)=>t.t-e.t)}(e,s,i.days),a={key:r,stamp:i.stamp,promise:o};return Ot.set(r,a),o.catch(()=>{Ot.get(r)===a&&Ot.delete(r)}),window.setTimeout(()=>{Ot.get(r)===a&&Ot.delete(r)},3e5),o}const Ut=864e5;const Ht=864e5;function It(t,e){const i=new Intl.DateTimeFormat("en-US",{timeZone:e,hourCycle:"h23",year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit",second:"2-digit"}),s={};for(const e of i.formatToParts(new Date(t)))"literal"!==e.type&&(s[e.type]=Number(e.value));return Date.UTC(s.year,s.month-1,s.day,s.hour,s.minute,s.second)-1e3*Math.floor(t/1e3)}function Ft(t,e){const i=/^(\d{4})-(\d{2})-(\d{2})/.exec(t);if(!i)return null;const s=Date.UTC(Number(i[1]),Number(i[2])-1,Number(i[3]));let r=s-It(s,e);return r=s-It(r,e),r}function Lt(t){const e=new Intl.DateTimeFormat("en-US",{timeZone:t,year:"numeric",month:"2-digit",day:"2-digit"}).formatToParts(new Date),i=t=>e.find(e=>e.type===t)?.value??"";return`${i("year")}-${i("month")}-${i("day")}`}function Bt(t,e,i,s,r){if(!(null!==t&&null!==e&&i&&s&&Number.isFinite(t)&&Number.isFinite(e)))return null;const n=Ft(i,r),o=Ft(function(t,e){const i=/^(\d{4})-(\d{2})-(\d{2})/.exec(t);return i?new Date(Date.UTC(Number(i[1]),Number(i[2])-1,Number(i[3]))+e*Ht).toISOString().slice(0,10):t}(s,1),r);return null===n||null===o||o-n<Ht?null:{startWeight:t,targetWeight:e,begin:n,finish:o}}function Gt(t,e){const i=t.finish-t.begin;if(i<=0)return t.targetWeight;const s=Math.min(1,Math.max(0,(e-t.begin)/i));return t.startWeight+(t.targetWeight-t.startWeight)*s}function Zt(t){const e=t.targetWeight-t.startWeight;return e<-.01?"lose":e>.01?"gain":"maintain"}function qt(t,e){if(t&&e)return t.states?.[e]}function Vt(t){return!!t&&!r.has(t.state)}function Kt(t,e){const i=qt(t,e);if(!Vt(i))return null;const s=Number(i.state);return Number.isFinite(s)?s:null}function Yt(t,e){const i=qt(t,e);return Vt(i)?i.state:null}function Jt(t,e){const i=Yt(t,e);if(!i)return null;const s=Date.parse(i);return Number.isFinite(s)?s:null}function Xt(t,e,i){const s=qt(t,e);return s?.attributes?.[i]}function Qt(t,e,i="kg"){return Xt(t,e,"unit_of_measurement")??i}function te(t){return t?.locale?.language||t?.language||"en"}function ee(t){const e=t.trim();return/^[+-]?(\d+([.,]\d*)?|[.,]\d+)$/.test(e)?Number(e.replace(",",".")):null}function ie(t,e){return new Intl.NumberFormat(te(t),{maximumFractionDigits:3,useGrouping:!1}).format(e)}function se(t,e,i=1){return null!==e&&Number.isFinite(e)?new Intl.NumberFormat(te(t),{minimumFractionDigits:i,maximumFractionDigits:i}).format(e):"–"}function re(t,e,i=!1){return null===e?"–":new Intl.DateTimeFormat(te(t),{day:"numeric",month:"short",...i?{year:"numeric"}:{},timeZone:t?.config?.time_zone}).format(new Date(e))}const ne=[["second",60],["minute",60],["hour",24],["day",7],["week",4.348],["month",12],["year",1/0]];function oe(t){return!!t&&"unavailable"!==t.state}class ae extends vt{constructor(){super(...arguments),this._measurements=[],this._loading=!1,this._fetchError=null,this._tracked=[],this._signature="",this._requestedStamp=null}set hass(t){if(this._hass=t,!t||!this._config)return;var e;this._context=jt(t,this._config),this._tracked=(e=this._context,Object.values(e.entities).filter(Boolean));const i=this._tracked.map(e=>{const i=t.states[e];return i?`${e}=${i.state}@${i.last_updated}`:`${e}=∅`}).join(",");i!==this._signature&&(this._signature=i,this._model=function(t,e){const i=e.entities,s=qt(t,i.status),r=Yt(t,i.status)??"no_goal",n=Kt(t,i.start_weight),o=Kt(t,i.target_weight),a=Yt(t,i.start_date),l=Yt(t,i.end_date),h=Bt(n,o,a,l,t.config?.time_zone??"UTC"),d=Xt(t,i.status,"direction"),c=qt(t,i.manual_weight),u=Jt(t,i.last_measurement);return{context:e,status:r,direction:d??(h?Zt(h):null),tolerance:Xt(t,i.status,"tolerance")??.5,goalMode:Xt(t,i.status,"goal_mode")??null,trendWindowDays:Xt(t,i.status,"trend_window_days")??null,unit:Qt(t,i.weight??i.start_weight),currentWeight:Kt(t,i.weight),lastMeasurement:u,measurementSource:Xt(t,i.weight,"source")??null,startWeight:n,targetWeight:o,ratePerWeek:Kt(t,i.rate_per_week),startDate:a,endDate:l,plannedToday:Kt(t,i.target_weight_today),deviation:Kt(t,i.deviation),trend:Kt(t,i.trend),remaining:Kt(t,i.remaining),weightProgress:Kt(t,i.weight_progress),timeProgress:Kt(t,i.time_progress),projectedDate:Jt(t,i.projected_date),manualWeight:Kt(t,i.manual_weight),manualDate:Yt(t,i.manual_date),manualPending:!0===Xt(t,i.manual_weight,"pending"),manualAvailable:oe(c),recordAvailable:oe(qt(t,i.record_weight)),startTodayArmed:oe(qt(t,i.confirm_start_today)),goal:h,stamp:[s?.state,u,n,o,a,l].join("|")}}(t,this._context),this._maybeLoad())}get hass(){return this._hass}setConfig(t){if(!t.entity&&!t.device_id&&!t.entities)throw new Error("Set `entity` to one entity of a Road to Weight Goal device, for example sensor.<name>_status.");this._config=t,this._signature="",this._requestedStamp=null,this._hass&&(this.hass=this._hass)}async _maybeLoad(){const t=this._hass,e=this._model;if(!t||!e||!this.needsMeasurements())return;const i=this.chartOptions(),s=function(t,e,i,s){const r=t??"goal";if("number"==typeof r)return Math.ceil(r)+1;if(!i)return 365;const n=Math.max(7,Math.ceil(e??0)),o=Math.ceil((s-i.begin)/Ut)+n;return o>0?Math.min(3650,Math.max(30,o)):365}(i.range,i.average,e.goal,Date.now()),r=`${e.stamp}|${i.source??"measurements"}|${s??"all"}`;if(r!==this._requestedStamp){this._requestedStamp=r,this._loading=!0;try{const n=await Wt(t,{source:"history"===i.source?"history":"measurements",days:s,target:e.context.target,weightEntity:e.context.entities.weight,stamp:e.stamp});this._requestedStamp===r&&(this._measurements=n,this._fetchError=null)}catch(e){this._requestedStamp===r&&(this._fetchError=e&&"object"==typeof e&&"message"in e?String(e.message):a(t,"card.load_failed"),this._requestedStamp=null)}finally{(this._requestedStamp===r||this._fetchError)&&(this._loading=!1)}}}shouldUpdate(t){return t.has("_config")||t.has("_model")||t.has("_measurements")||t.has("_loading")||t.has("_fetchError")}renderProblem(t){return it`
      <ha-card>
    ...
    `}missingGoalMessage(){const t=this._config,e=this._hass;if(!t||!e)return null;const i=this._context;return i&&Object.keys(i.entities).length?i.target?null:a(e,"card.no_target"):a(e,"card.no_entities",{anchor:t.entity??t.device_id??"?"})}}u([St()],ae.prototype,"_config",void 0),u([St()],ae.prototype,"_model",void 0),u([St()],ae.prototype,"_measurements",void 0),u([St()],ae.prototype,"_loading",void 0),u([St()],ae.prototype,"_fetchError",void 0),u([Et({attribute:!1})],ae.prototype,"hass",null);let le=class extends vt{constructor(){super(...arguments),this.showRecord=!0,this.showRecordDate=!0,this.showRestart=!0,this._draft=null,this._dayDraft=null,this._error=null,this._busy=!1,this._onInput=t=>{this._draft=t.target.value,this._error=null},this._onDayInput=t=>{this._dayDraft=t.target.value,this._error=null},this._onKeydown=t=>{"Enter"===t.key&&this.model&&(t.preventDefault(),this._save(this.model))}}render(){const t=this.model;if(!t||!this.hass)return nt;const e=h(this.hass),i=t.context.entities,s=this.showRecord&&t.manualAvailable&&!!i.manual_weight,r=this.showRestart&&!!i.start_today&&null!==t.goal;if(!s&&!r)return nt;const n=this._draft??(null===t.manualWeight?"":ie(this.hass,t.manualWeight)),o=Lt(this.hass.config?.time_zone),a=this._day(t,o);return it`
      ...
      <div class="actions">
        ${s?it`
              ${this.showRecordDate?it`<input
                    class="day ${this.hass.themes?.darkMode?"dark":""}"
                    type="date"
                    max=${o}
                    .value=${a}
                    aria-label=${e("actions.date_input")}
                    ?disabled=${this._busy}
    ...
    `}_day(t,e){return this.showRecordDate?this._dayDraft??t.manualDate??e:e}_hasDraft(t){return null!==this._draft?null!==ee(this._draft):t.manualPending}async _save(t){const e=t.context.target;if(!this.hass||!e)return;const i=ee(this._draft??String(t.manualWeight??""));if(null===i)return void(this._error=a(this.hass,"actions.enter_number"));const s=Lt(this.hass.config?.time_zone),r=this._day(t,s)||s;if(r>s)this._error=a(this.hass,"actions.future_date");else{this._busy=!0,this._error=null;try{await this.hass.callService("weight_goal","record_weight",r===s?{weight:i}:{weight:i,timestamp:`${r}T12:00:00`},{entity_id:e}),this._draft=null,this._dayDraft=s}catch(t){this._error=he(this.hass,t)}finally{this._busy=!1}}}async _press(t,e){const i=t.context.entities[e];if(this.hass&&i){this._busy=!0;try{await this.hass.callService("button","press",{},{entity_id:i}),this._error=null}catch(t){this._error=he(this.hass,t)}finally{this._busy=!1}}}};function he(t,e){if(e&&"object"==typeof e&&"message"in e){const t=String(e.message);if(t)return t}return a(t,"actions.failed")}le.styles=[Mt,y`
      .actions {
        display: flex;
        flex-wrap: wrap;
        gap: 8px;
    ...
    `],u([Et({attribute:!1})],le.prototype,"hass",void 0),u([Et({attribute:!1})],le.prototype,"model",void 0),u([Et({type:Boolean})],le.prototype,"showRecord",void 0),u([Et({type:Boolean})],le.prototype,"showRecordDate",void 0),u([Et({type:Boolean})],le.prototype,"showRestart",void 0),u([St()],le.prototype,"_draft",void 0),u([St()],le.prototype,"_dayDraft",void 0),u([St()],le.prototype,"_error",void 0),u([St()],le.prototype,"_busy",void 0),le=u([xt("wg-actions")],le);const de={last_measurement:{key:"last_measurement",icon:"mdi:clock-outline",relative:!0},projected_date:{key:"projected_date",icon:"mdi:calendar-clock",relative:!0},trend:{key:"trend",icon:"mdi:chart-line-variant",signed:!0},deviation:{key:"deviation",icon:"mdi:plus-minus-variant",signed:!0},remaining:{key:"remaining",icon:"mdi:flag-checkered"},target_weight_today:{key:"target_weight_today",icon:"mdi:target"},weight_progress:{key:"weight_progress",icon:"mdi:scale-balance"},time_progress:{key:"time_progress",icon:"mdi:calendar-range"},start_weight:{key:"start_weight",icon:"mdi:ray-start"},target_weight:{key:"target_weight",icon:"mdi:ray-end"},rate_per_week:{key:"rate_per_week",icon:"mdi:speedometer"},start_date:{key:"start_date",icon:"mdi:calendar-start"},end_date:{key:"end_date",icon:"mdi:calendar-end"}},ce=[...Object.keys(de),"source"],ue=["last_measurement","trend","remaining","projected_date"],pe={manual:"mdi:pencil-outline",sensor:"mdi:scale-bathroom",service:"mdi:cog-outline",import:"mdi:database-import-outline"};function me(t,e){const i=e.measurementSource;if(!i)return null;const s=pe[i]?a(t,`badge.source.${i}`):i;return{key:"source",icon:pe[i]??"mdi:help-circle-outline",text:s,label:s,entityId:e.context.entities.weight}}function ge(t,e,i){const s=de[i],r=e.context.entities[s.key],n=qt(t,r);if(!r||!Vt(n))return null;let o;if(s.relative){const e=Date.parse(n.state);if(!Number.isFinite(e))return null;o=function(t,e){if(null===e)return"–";const i=new Intl.RelativeTimeFormat(te(t),{numeric:"auto"});let s=(e-Date.now())/1e3;for(const[t,e]of ne){if(Math.abs(s)<e||e===1/0)return i.format(Math.round(s),t);s/=e}return i.format(Math.round(s),"year")}(t,e)}else if(s.signed){const e=Number(n.state);if(!Number.isFinite(e))return null;const i=n.attributes.unit_of_measurement??"";o=`${function(t,e,i=1){return null!==e&&Number.isFinite(e)?new Intl.NumberFormat(te(t),{minimumFractionDigits:i,maximumFractionDigits:i,signDisplay:"exceptZero"}).format(e):"–"}(t,e,1)}${i?` ${i}`:""}`}else o=c(t,n);return{key:i,icon:s.icon,text:o,label:d(t,r,e.context.name),entityId:r}}function _e(t,e,i){const s=qt(t,i.entity);return Vt(s)?{key:i.entity,icon:i.icon??s.attributes.icon??"mdi:information-outline",text:c(t,s),label:i.name??d(t,i.entity,e.context.name),entityId:i.entity}:null}let fe=class extends vt{render(){const t=this.model;if(!t||!this.hass)return nt;const e=h(this.hass),i=function(t,e,i){const s=i??ue,r=[];for(const i of s){if("object"==typeof i&&i?.entity){const s=_e(t,e,i);s&&r.push(s);continue}if("source"===i){const i=me(t,e);i&&r.push(i);continue}if("string"==typeof i&&i in de){const s=ge(t,e,i);s&&r.push(s)}}return r}(this.hass,t,this.badges);return 0===i.length?null===t.currentWeight?it`<div class="chips">
            <span class="chip">
    ...
    >
      ...
      <span>${t.text}</span>
    </button>`}_more(t){t&&this.dispatchEvent(new CustomEvent("hass-more-info",{detail:{entityId:t},bubbles:!0,composed:!0}))}};fe.styles=[Mt,y`
      .chips {
        display: flex;
        flex-wrap: wrap;
        gap: 6px;
    ...
    `],u([Et({attribute:!1})],fe.prototype,"hass",void 0),u([Et({attribute:!1})],fe.prototype,"model",void 0),u([Et({attribute:!1})],fe.prototype,"badges",void 0),fe=u([xt("wg-badges")],fe);const ye=1;class be{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,i){this._$Ct=t,this._$AM=e,this._$Ci=i}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}}const $e=(t=>(...e)=>({_$litDirective$:t,values:e}))(class extends be{constructor(t){if(super(t),t.type!==ye||"class"!==t.name||t.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(t){return" "+Object.keys(t).filter(e=>t[e]).join(" ")+" "}update(t,[e]){if(void 0===this.st){this.st=new Set,void 0!==t.strings&&(this.nt=new Set(t.strings.join(" ").split(/\s/).filter(t=>""!==t)));for(const t in e)e[t]&&!this.nt?.has(t)&&this.st.add(t);return this.render(e)}const i=t.element.classList;for(const t of this.st)t in e||(i.remove(t),this.st.delete(t));for(const t in e){const s=!!e[t];s===this.st.has(t)||this.nt?.has(t)||(s?(i.add(t),this.st.add(t)):(i.remove(t),this.st.delete(t)))}return rt}});function ve(t){return Math.round(100*t)/100}function we(t){return t.map((t,e)=>`${0===e?"M":"L"}${ve(t.x)},${ve(t.y)}`).join(" ")}function xe(t,e){return 0===t.length?"":1===t.length?`M${ve(t[0].x)},${ve(t[0].y)}`:"step"===e?function(t){const e=[`M${ve(t[0].x)},${ve(t[0].y)}`];for(let i=1;i<t.length;i++)e.push(`H${ve(t[i].x)}`,`V${ve(t[i].y)}`);return e.join(" ")}(t):"smooth"===e?function(t){if(t.length<3)return we(t);const e=[`M${ve(t[0].x)},${ve(t[0].y)}`];for(let i=0;i<t.length-1;i++){const s=t[0===i?0:i-1],r=t[i],n=t[i+1],o=t[i+2>=t.length?t.length-1:i+2],a=Math.min(r.y,n.y),l=Math.max(r.y,n.y),h=t=>Math.min(l,Math.max(a,t)),d=r.x+(n.x-s.x)/6,c=h(r.y+(n.y-s.y)/6),u=n.x-(o.x-r.x)/6,p=h(n.y-(o.y-r.y)/6);e.push(`C${ve(d)},${ve(c)} ${ve(u)},${ve(p)} ${ve(n.x)},${ve(n.y)}`)}return e.join(" ")}(t):we(t)}function ke(t){if(!Number.isFinite(t)||t<=0)return 1;const e=10**Math.floor(Math.log10(t)),i=t/e;return(i>5?10:i>2?5:i>1?2:1)*e}function Ae(t){return Number(t.toFixed(6))}function Ee(t,e={}){const i=t.filter(t=>Number.isFinite(t));let s=i.length?Math.min(...i):0,r=i.length?Math.max(...i):1;if(r-s<1e-9){const t=Math.max(.02*Math.abs(r),.5);s-=t,r+=t}const n=Math.max(1,e.ticks??4);if("tight"!==e.mode){const t=ke((r-s)/n);s=Math.floor(s/t)*t,r=Math.ceil(r/t)*t}"number"==typeof e.min&&Number.isFinite(e.min)&&(s=e.min),"number"==typeof e.max&&Number.isFinite(e.max)&&(r=e.max),r<=s&&(r=s+Math.max(ke(.02*Math.abs(s)),1)),s=Ae(s),r=Ae(r);const o=ke((r-s)/n),a=o>=1?0:o>=.1?1:2,l=[s],h=.4*o;for(let t=Math.ceil((s+h)/o)*o;t<r-h;t+=o){const e=Ae(t);e>s&&e<r&&l.push(e)}r>s&&l.push(r);const d=l.map(t=>function(t,e){for(let i=e;i<2;i++)if(Math.abs(Number(t.toFixed(i))-t)<1e-6)return i;return 2}(t,a));return{min:s,max:r,step:o,ticks:l,decimals:d}}const Se={weight:{color:"auto",width:2,dash:"",opacity:1,point_size:3},average:{color:"var(--primary-color, #03a9f4)",width:2.5,dash:"",opacity:1,point_size:0},plan:{color:"var(--secondary-text-color, #727272)",width:2,dash:"6 4",opacity:1,point_size:0},band:{color:"var(--primary-color, #03a9f4)",width:0,dash:"",opacity:.1,point_size:0},projection:{color:"var(--disabled-text-color, #9e9e9e)",width:2,dash:"2 6",opacity:1,point_size:0}};let Me=class extends vt{constructor(){super(...arguments),this.measurements=[],this.options={},this.loading=!1,this._width=0,this._hover=null,this._id=Math.random().toString(36).slice(2,9),this._clearHover=()=>{this._hover=null}}connectedCallback(){super.connectedCallback(),this._observer=new ResizeObserver(t=>{const e=Math.round(t[0]?.contentRect.width??0);e&&e!==this._width&&(this._width=e)}),this._observer.observe(this)}disconnectedCallback(){this._observer?.disconnect(),this._observer=void 0,super.disconnectedCallback()}get _height(){return this.options.height??190}_style(t){const e=(this.options.styles??{})[t];return{...Se[t],...e??{}}}_colour(t){const e=this._style(t).color;return"auto"!==e?e:i[this.model?.status??"no_goal"]??i.on_track}_shown(t,e){const i=this.options.show?.[t];return void 0===i?e:i}_window(t){return function(t,e,i,s){const r=t??"goal";if("goal"===r&&e){const t=i[i.length-1]?.t??s;return{from:e.begin,to:Math.max(e.finish,t,s)}}if("number"==typeof r&&r>0)return{from:s-r*Ut,to:s};const n=i[0]?.t??s-2592e6,o=Math.max(i[i.length-1]?.t??s,s);return{from:n,to:o>n?o:n+Ut}}(this.options.range,this.model?.goal,t,Date.now())}_renderEmpty(t){return it`<div class="empty" style=${`height:${this._height}px`}>
        ...
        <table class="sr-only">
          ...
          <tbody>
            ${n.slice(-12).map(e=>it`<tr>
                <td>${re(this.hass,e.t,!0)}</td>
                <td>${se(this.hass,e.v,1)} ${t.unit}</td>
              </tr>`)}
          </tbody>
        </table>
      </div>
    `}_axisWidth(t){const e=Math.max(...t.ticks.map((e,i)=>se(this.hass,e,t.decimals[i]).length),2);return 14+7*e}_verticalScale(t,e,i,s,r){const n=this.options.y_axis??{},o=[];for(const t of e)o.push(t.v);for(const t of i)o.push(t.v);if(t.goal&&!1!==n.include_goal){const e=this._shown("band",!0)?t.tolerance:0;for(const i of this._planPoints(t,s,r))o.push(i.v+e,i.v-e)}return o.length||o.push(t.currentWeight??75),Ee(o,{min:n.min,max:n.max,mode:"tight"===n.mode?"tight":"nice",ticks:n.ticks??4})}_renderGrid(t,e,i,s,r,n){if(!this._shown("grid",!0))return nt;const o=t.ticks.map((o,a)=>{const l=r(o);return st`
        <line class="grid" x1=${e} x2=${s-i}
              y1=${l} y2=${l}></line>
        ${n?st`<text class="axis" x=${e-6} y=${l+3}
                        text-anchor="end">${se(this.hass,o,t.decimals[a])}</text>`:nt}
      `});return st`<g>${o}</g>`}_renderBand(t,e,i,s,r){if(!t.goal||!this._shown("band",!0)||t.tolerance<=0)return nt;const n=this._style("band"),o=this._planPoints(t,e,i),a=o.map(e=>({x:s(e.t),y:r(e.v+t.tolerance)})),l=o.map(e=>({x:s(e.t),y:r(e.v-t.tolerance)})),h=function(t,e){if(t.length<2||e.length<2)return"";const i=we(t),s=e.slice().reverse().map(t=>`L${ve(t.x)},${ve(t.y)}`).join(" ");return`${i} ${s} Z`}(a,l);return h?st`<path d=${h} fill=${this._colour("band")}
                     fill-opacity=${n.opacity} stroke="none"></path>`:nt}_planPoints(t,e,i){const s=t.goal,r=[e,s.begin,s.finish,i].filter(t=>t>=e&&t<=i).sort((t,e)=>t-e),n=r.filter((t,e)=>0===e||t!==r[e-1]);return n.map(t=>({t,v:Gt(s,t)}))}_renderPlan(t,e,i,s,r){if(!t.goal||!this._shown("plan",!0))return nt;const n=this._style("plan"),o=this._planPoints(t,e,i).map(t=>({x:s(t.t),y:r(t.v)}));return st`
      <path d=${xe(o,"linear")} fill="none"
    ...
    `}_renderProjection(t,e,i,s){if(!this._shown("projection",!0)||!t.goal||null===t.projectedDate||!e.length)return nt;const r=this._style("projection"),n=e[e.length-1],o=xe([{x:i(n.t),y:s(n.v)},{x:i(t.projectedDate),y:s(t.goal.targetWeight)}],"linear");return st`<path d=${o} fill="none" stroke=${this._colour("projection")}
      ...
      <path d=${xe(t,i)} fill="none"
            stroke=${this._colour("weight")}
            stroke-width=${s.width}
            stroke-dasharray=${s.dash||nt}
            stroke-opacity=${n?.45*s.opacity:s.opacity}
            stroke-linecap="round" stroke-linejoin="round"></path>
      ${n?st`<path d=${xe(e,i)} fill="none"
                      stroke=${this._colour("average")}
                      stroke-width=${r.width}
                      stroke-dasharray=${r.dash||nt}
                      stroke-opacity=${r.opacity}
                      stroke-linecap="round" stroke-linejoin="round"></path>`:nt}
    `}_renderPoints(t,e,i,s){const r=this._style("weight");if(!this._shown("points",!0)||r.point_size<=0)return nt;const n=Math.ceil(t.length/120),o=this._colour("weight"),a=t.filter((e,i)=>i%n===0||i===t.length-1).map(t=>{const n=null!==s.goal&&Math.abs(t.v-Gt(s.goal,t.t))>s.tolerance;return st`<circle cx=${e(t.t)} cy=${i(t.v)} r=${r.point_size}
                  ...
                  text-anchor=${l}>${re(this.hass,a)}</text>`)}return st`<g>${n}</g>`}_renderCursor(t,e,i,s,r){if(null===this._hover||!t[this._hover])return nt;const n=t[this._hover];return st`
    ...
    `}_renderTooltip(t,e){if(null===this._hover||!t[this._hover])return nt;const i=t[this._hover],s=e.goal?Gt(e.goal,i.t):null,r=null===s?null:i.v-s;return it`<div
      class=${$e({tooltip:!0,right:this._hover>t.length/2})}
      role="status"
    >
      <strong>${se(this.hass,i.v,1)} ${e.unit}</strong>
      <span>${re(this.hass,i.t,!0)}</span>
      ${null===r?nt:it`<span
            >${a(this.hass,"chart.vs_plan",{value:`${r>0?"+":""}${se(this.hass,r,1)}`,unit:e.unit})}</span
          >`}
    </div>`}_onPointer(t,e,i,s,r,n){if(!e.length)return;const o=t.currentTarget.getBoundingClientRect(),a=(t.clientX-o.left-r)/Math.max(1,n),l=function(t,e){if(0===t.length)return-1;let i=0,s=1/0;for(let r=0;r<t.length;r++){const n=Math.abs(t[r].t-e);n<s&&(s=n,i=r)}return i}(e,i+Math.min(1,Math.max(0,a))*(s-i));l!==this._hover&&(this._hover=l)}_summary(t,e){const i=h(this.hass),s=t.unit,r=[i("chart.summary_readings",{count:e.length}),null===t.currentWeight?i("chart.summary_no_weight"):i("chart.summary_current",{value:se(this.hass,t.currentWeight,1),unit:s})];return null!==t.deviation&&r.push(i(t.deviation>=0?"chart.summary_above":"chart.summary_below",{value:se(this.hass,Math.abs(t.deviation),1),unit:s})),t.goal&&r.push(i("chart.summary_plan",{start:se(this.hass,t.goal.startWeight,1),target:se(this.hass,t.goal.targetWeight,1),unit:s})),r.join(", ")}};Me.styles=y`
    :host {
      display: block;
      position: relative;
    }
  ...
  `,u([Et({attribute:!1})],Me.prototype,"hass",void 0),u([Et({attribute:!1})],Me.prototype,"model",void 0),u([Et({attribute:!1})],Me.prototype,"measurements",void 0),u([Et({attribute:!1})],Me.prototype,"options",void 0),u([Et({type:Boolean})],Me.prototype,"loading",void 0),u([St()],Me.prototype,"_width",void 0),u([St()],Me.prototype,"_hover",void 0),Me=u([xt("wg-chart")],Me);let Ce=class extends vt{constructor(){super(...arguments),this.open=!1,this._error=null}render(){const t=this.model;if(!t||!this.hass)return nt;const e=t.context.entities,i=t.goalMode;return it`
      <details ?open=${this.open}>
        ...
        <div class="grid">
          ...
          ${this._numberRow(e.rate_per_week,`${t.unit}/w`,"target"===i)}
    ...
    `}_numberRow(t,e,i){if(!t||!this.hass)return nt;const s=this.hass.states[t];if(!s)return nt;const r=(Xt(this.hass,t,"min")??0)<0,n=Number(s.state),o=""!==s.state.trim()&&Number.isFinite(n)?ie(this.hass,n):"";return it`<label class="field">
      <span class="muted">
      ...
      <span class="input">
        <input
          class="number"
          type="text"
          inputmode=${r?"text":"decimal"}
          autocomplete="off"
          .value=${o}
          ?disabled=${i||"unavailable"===s.state}
          aria-describedby=${i?"derived":nt}
          @change=${e=>this._setNumber(t,e.target.value)}
        />
        <span class="unit muted">${e}</span>
      </span>
    </label>`}_dateRow(t){if(!t||!this.hass?.states[t])return nt;const e=this.hass.states[t];return it`<label class="field">
      <span class="muted"
    ...
    </label>`}async _setNumber(t,e){const i=ee(e);if(this.hass&&null!==i)try{await this.hass.callService("number","set_value",{value:i},{entity_id:t}),this._error=null}catch(t){this._error=he(this.hass,t)}}async _setDate(t,e){if(this.hass&&e)try{await this.hass.callService("date","set_value",{date:e},{entity_id:t}),this._error=null}catch(t){this._error=he(this.hass,t)}}};Ce.styles=[Mt,y`
      details {
    ...
    `],u([Et({attribute:!1})],Ce.prototype,"hass",void 0),u([Et({attribute:!1})],Ce.prototype,"model",void 0),u([Et({type:Boolean})],Ce.prototype,"open",void 0),u([St()],Ce.prototype,"_error",void 0),Ce=u([xt("wg-goal-editor")],Ce);let Pe=class extends vt{constructor(){super(...arguments),this.name="",this.compact=!1,this._openStatus=()=>{const t=this.model?.context.entities.status;t&&this.dispatchEvent(new CustomEvent("hass-more-info",{detail:{entityId:t},bubbles:!0,composed:!0}))}}render(){const t=this.model;if(!t)return nt;const e=t.status,r=i[e]??i.no_goal;if(this.compact)return it`
        <div class="compact">
          <span class="name" title=${this.name}>${this.name}</span>
          ${null===t.currentWeight?nt:it`<span class="now" style=${`color:${r}`}
                >${se(this.hass,t.currentWeight,1)}
                ${t.unit}</span
              >`}
        </div>
      `;const n=c(this.hass,qt(this.hass,t.context.entities.status))||e;return it`
      <div class="header">
        ...
        <div class="titles">
          ...
          ${t.endDate?it`<span class="muted sub"
                >${a(this.hass,"header.until",{date:c(this.hass,qt(this.hass,t.context.entities.end_date))||t.endDate})}</span
              >`:nt}
        </div>
        <button
          class="status"
    ...
    `],u([Et({attribute:!1})],Pe.prototype,"hass",void 0),u([Et({attribute:!1})],Pe.prototype,"model",void 0),u([Et()],Pe.prototype,"name",void 0),u([Et()],Pe.prototype,"icon",void 0),u([Et({type:Boolean})],Pe.prototype,"compact",void 0),Pe=u([xt("wg-header")],Pe);let De=class extends vt{render(){const t=this.model;if(!t||!this.hass)return nt;const e=h(this.hass),s=i[t.status]??i.no_goal;return it`
      <div class="hero">
        <button
          class="value"
        ...
        >
          <span class="number"
            >${se(this.hass,t.currentWeight,1)}</span
          >
        ...
        ${null===t.deviation?nt:it`<div class="deviation" style=${`color:${s}`}>
              ...
              ></ha-icon>
              <span>
                ${0===t.deviation?e("hero.on_plan"):`${se(this.hass,Math.abs(t.deviation),1)} ${t.unit} ${t.deviation>0?e("hero.above_plan"):e("hero.below_plan")}`}
              </span>
            </div>`}
      </div>
    `}_more(t){t&&this.dispatchEvent(new CustomEvent("hass-more-info",{detail:{entityId:t},bubbles:!0,composed:!0}))}};De.styles=[Mt,y`
      .hero {
        display: flex;
        align-items: baseline;
        flex-wrap: wrap;
    ...
    `],u([Et({attribute:!1})],De.prototype,"hass",void 0),u([Et({attribute:!1})],De.prototype,"model",void 0),De=u([xt("wg-hero")],De);let ze=class extends vt{render(){const t=this.model;if(!t||null===t.weightProgress&&null===t.timeProgress)return nt;const e=i[t.status]??i.on_track;return it`
    ...
    `}_bar(t,e,i){if(null===e)return it`<div class="line">
      ...
      <span class="value">${se(this.hass,s,0)}%</span>
    </div>`}};ze.styles=[Mt,y`
      .line {
        display: grid;
      ...
      <ha-card>
        <div class="content">
          ...
          ${r?it`<wg-actions
                ...
                .showRecordDate=${!1!==i.show_record_date}
    ...
    `],Ne=u([xt(e)],Ne),window.customCards=window.customCards??[];const Re=navigator.language||"en",Te=[{type:e,name:l(Re,"picker.card_name"),description:l(Re,"picker.card_description"),preview:!0,documentationURL:"https://github.com/julezdean/ha-weight-goal"}];for(const t of Te)window.customCards.some(e=>e.type===t.type)||window.customCards.push(t);let je;function Oe(e,i){if("source"===i)return a(e,"badge.source.sensor");const s=`component.${t}.entity.sensor.${i}.name`,r=e?.localize?.(s);if("string"==typeof r&&r)return r;for(const s of["number","date"]){const r=e?.localize?.(`component.${t}.entity.${s}.${i}.name`);if("string"==typeof r&&r)return r}return i}function We(t){return[{name:"",type:"grid",schema:[{name:"source",selector:{select:{mode:"dropdown",options:[{value:"measurements",label:t("editor.source_measurements")},{value:"history",label:t("editor.source_history")}]}}},{name:"range",selector:{select:{mode:"dropdown",custom_value:!0,options:[{value:"goal",label:t("editor.range_goal")},{value:"30",label:t("editor.range_30")},{value:"90",label:t("editor.range_90")},{value:"365",label:t("editor.range_365")},{value:"all",label:t("editor.range_all")}]}}},{name:"line",selector:{select:{mode:"dropdown",options:[{value:"smooth",label:t("editor.line_smooth")},{value:"linear",label:t("editor.line_linear")},{value:"step",label:t("editor.line_step")}]}}},{name:"average",selector:{number:{min:0,max:60,step:1,mode:"box",unit_of_measurement:"d"}}},{name:"height",selector:{number:{min:100,max:500,step:10,mode:"box",unit_of_measurement:"px"}}}]},{name:"y_axis",type:"expandable",title:t("editor.y_axis"),schema:[{name:"",type:"grid",schema:[{name:"mode",selector:{select:{mode:"dropdown",options:[{value:"nice",label:t("editor.mode_nice")},{value:"tight",label:t("editor.mode_tight")}]}}},{name:"include_goal",selector:{boolean:{}}},{name:"min",selector:{number:{min:0,max:500,step:.5,mode:"box"}}},{name:"max",selector:{number:{min:0,max:500,step:.5,mode:"box"}}},{name:"ticks",selector:{number:{min:2,max:10,step:1,mode:"box"}}}]}]},{name:"show",type:"expandable",title:t("editor.layers"),schema:[{name:"",type:"grid",schema:[{name:"band",selector:{boolean:{}}},{name:"plan",selector:{boolean:{}}},{name:"average",selector:{boolean:{}}},{name:"projection",selector:{boolean:{}}},{name:"points",selector:{boolean:{}}},{name:"today",selector:{boolean:{}}},{name:"grid",selector:{boolean:{}}},{name:"axis",selector:{boolean:{}}}]}]}]}console.info("%c WEIGHT-GOAL-CARD %c 0.8.0 ","color:#fff;background:#03a9f4;font-weight:700","color:#03a9f4;background:#fff;font-weight:700");const Ue={entity:"editor.entity",name:"editor.name",icon:"editor.icon",badges:"editor.badges",source:"editor.source",range:"editor.range",line:"editor.line",average:"editor.average",height:"editor.height",mode:"editor.mode",include_goal:"editor.include_goal",min:"editor.min",max:"editor.max",ticks:"editor.ticks",band:"editor.band",plan:"editor.plan",projection:"editor.projection",points:"editor.points",today:"editor.today",grid:"editor.grid",axis:"editor.axis",show_header:"editor.show_header",header:"editor.header",show_hero:"editor.show_hero",show_badges:"editor.show_badges",show_chart:"editor.show_chart",show_progress:"editor.show_progress",show_record:"editor.show_record",show_record_date:"editor.show_record_date",show_restart:"editor.show_restart",show_goal_editor:"editor.show_goal_editor"},He={entity:"editor.entity_help",badges:"editor.badges_help",source:"editor.source_help",average:"editor.average_help",range:"editor.range_help",mode:"editor.mode_help",include_goal:"editor.include_goal_help",min:"editor.axis_bound_help",max:"editor.axis_bound_help"};let Ie=class extends vt{constructor(){super(...arguments),this._ready=!1,this._changed=t=>{t.stopPropagation();const e={...t.detail.value};"string"==typeof e.range&&/^\d+$/.test(e.range)&&(e.range=Number(e.range));const i=(this._config?.badges??[]).filter(t=>"object"==typeof t);i.length&&(e.badges=[...e.badges??[],...i]),this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0}))}}setConfig(t){this._config=t}connectedCallback(){super.connectedCallback(),(je||(je=(async()=>{if(customElements.get("ha-form"))return;const t=await(window.loadCardHelpers?.());if(!t)return;const e=t.createCardElement({type:"entities",entities:[]}).constructor.getConfigElement;e&&await e()})().catch(()=>{})),je).then(()=>{this._ready=!0})}_schema(){const e=h(this.hass);return[{name:"entity",required:!0,selector:{entity:{integration:t,domain:"sensor"}}},{name:"",type:"grid",schema:[{name:"name",selector:{text:{}}},{name:"icon",selector:{icon:{}}}]},(i=this.hass,{name:"badges",selector:{select:{multiple:!0,mode:"list",options:ce.map(t=>({value:t,label:Oe(i,t)}))}}}),{name:"",type:"expandable",title:e("editor.sections"),schema:[{name:"",type:"grid",schema:[{name:"show_header",selector:{boolean:{}}},{name:"show_hero",selector:{boolean:{}}},{name:"show_badges",selector:{boolean:{}}},{name:"show_chart",selector:{boolean:{}}},{name:"show_progress",selector:{boolean:{}}},{name:"show_record",selector:{boolean:{}}},{name:"show_record_date",selector:{boolean:{}}},{name:"show_restart",selector:{boolean:{}}},{name:"show_goal_editor",selector:{boolean:{}}}]},{name:"header",selector:{select:{mode:"dropdown",options:[{value:"full",label:e("editor.header_full")},{value:"compact",label:e("editor.header_compact")}]}}}]},{name:"",type:"expandable",title:e("editor.chart"),schema:We(e)}];var i}render(){return this.hass&&this._config?this._ready||customElements.get("ha-form")?it`
      <ha-form
        .hass=${this.hass}
        .data=${this._defaults()}
        .schema=${this._schema()}
        .computeLabel=${t=>function(t,e){const i=Ue[e.name];return i?a(t,i):e.title??e.name}(this.hass,t)}
        .computeHelper=${t=>function(t,e){const i=He[e.name];return i?a(t,i):void 0}(this.hass,t)}
        @value-changed=${this._changed}
      ></ha-form>
    `:it`<p class="fallback">
        ${a(this.hass,"editor.loading")}
      </p>`:nt}_defaults(){const t=this._config;return{show_header:!0,header:"full",show_hero:!0,show_badges:!0,show_chart:!0,show_progress:!0,show_record:!0,show_record_date:!0,show_restart:!0,show_goal_editor:!0,source:"measurements",range:"goal",line:"smooth",average:7,...t,badges:(t.badges??ue).filter(t=>"string"==typeof t),y_axis:{mode:"nice",include_goal:!0,...t.y_axis??{}},show:{band:!0,plan:!0,average:!0,projection:!0,points:!0,today:!0,grid:!0,axis:!0,...t.show??{}}}}};Ie.styles=y`
    .fallback {
      color: var(--secondary-text-color, #727272);
      font-size: 14px;
    }
  `,u([Et({attribute:!1})],Ie.prototype,"hass",void 0),u([St()],Ie.prototype,"_config",void 0),u([St()],Ie.prototype,"_ready",void 0),Ie=u([xt(`${e}-editor`)],Ie);var Fe=Object.freeze({__proto__:null,get WeightGoalCardEditor(){return Ie}});
